...
export interface paths {
    ...
    "/api/v1/ranking/custom-formats": {
        ...
        /**
         * Get Trash Custom Formats
         * @description Retrieve default TRaSH Guides custom formats catalog and profiles.
         */
        get: operations["get_trash_custom_formats"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/ranking/custom-formats/evaluate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Evaluate Trash Custom Formats
         * @description Evaluate a release title against TRaSH Custom Formats without saving settings.
         */
        post: operations["evaluate_trash_custom_formats"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/webhook/plex": {
        ...
        /**
         * Plex Webhook
         * @description Plex webhook: parse stream events (play/pause/stop/scrobble), attribute sessions & sync Trakt.
         *
...
export interface components {
    schemas: {
         ...
         * @description System-wide aggregated playback and VFS cache metrics.
         */
        AggregatePlaybackMetrics: {
            /**
            ...
            /**
             * Total Cache Hits
             * @description Cumulative cache hits in chunks
             * @default 0
             */
            total_cache_hits: number;
            /**
             * Total Cache Misses
             * @description Cumulative cache misses in chunks
             * @default 0
             */
            total_cache_misses: number;
            /**
             * Total Chunk Requests
             * @description Cumulative chunk requests (hits + misses)
             * @default 0
             */
         ...
         * @description Discrete operational event emitted during streaming lifecycle.
         */
        PlaybackTelemetryEvent: {
            /**
             * Event Id
         ...
         * @description Complete real-time playback telemetry snapshot delivered via REST and 1Hz SSE.
         */
        PlaybackTelemetrySnapshot: {
            /**
             * Timestamp
        ...
        RankingTestResponse: {
            ...
            trash_summary?: components["schemas"]["TrashEvaluationSummary"] | null;
        };
        /** RarbgConfig */
        RarbgConfig: {
            /**
        ...
        ScraperModel: {
            ...
            trash_scoring?: components["schemas"]["TrashSettingsConfig"];
        };
        /** SelectFilesResponse */
        SelectFilesResponse: {
            /** Message */
        ...
        /**
         * StreamSessionMetric
         * @description Real-time metric snapshot for an active VFS or HTTP media stream.
         */
        StreamSessionMetric: {
            /**
             * Stream Id
            ...
            /**
             * Client User Agent
             * @description Client user agent string (e.g. Plex, VLC, ExoPlayer)
             */
            ...
            /**
             * User Name
             * @description Plex/client username (e.g. Alice)
             */
            user_name?: string | null;
            /**
             * Player Device
             * @description Plex client device/player name (e.g. Apple TV 4K, Shield)
             */
            player_device?: string | null;
            /**
             * Playback State
             ...
             * @enum {string}
             */
            playback_state: "playing" | "paused" | "buffering" | "stopped" | "unknown";
            /**
             * Decision
             * @description Playback streaming decision (direct_play, direct_stream, transcode)
             */
            decision?:
                | ("direct_play" | "direct_stream" | "transcode" | "direct" | "unknown")
                | null;
            /**
             * Video Decision
             * @description Video stream transcode/direct decision
             */
            video_decision?: string | null;
            /**
             * Audio Decision
             * @description Audio stream transcode/direct decision
             */
            audio_decision?: string | null;
            /**
             * Quality Profile
             * @description Playback quality label (e.g. 4K, 1080p, 720p, Original)
             */
            quality_profile?: string | null;
            /**
             * Media Resolution
             * @description Media resolution string (e.g. 4k, 1080, 720)
             */
            media_resolution?: string | null;
            /**
             * Media Bitrate Kbps
             * @description Media stream bitrate in kbps
             */
            media_bitrate_kbps?: number | null;
            /**
             * Session Badge
             * @description Formatted live session badge (e.g. 'Alice · 4K Direct Play · 42 Mbps · RD Cache')
             */
            session_badge?: string | null;
        };
        /** StreamsResponse */
        StreamsResponse: {
            /** Message */
        ...
        /**
         * TrashCondition
         * @description A single matching condition within a TRaSH custom format.
         */
        TrashCondition: {
            /**
             * Name
             * @description Name or description of the condition
             * @default
             */
            name: string;
            /**
            ...
            /**
             * Negate
             * @description If True, match succeeds when pattern does NOT match
             * @default false
             */
            negate: boolean;
            /**
        ...
        /**
         * TrashCustomFormat
         * @description Definition of a TRaSH Custom Format with scoring and conditions.
         */
        TrashCustomFormat: {
            /**
             * Trash Id
            ...
            /**
             * Name
             * @description Human readable name of the custom format
             */
            name: string;
            /**
             * Category
             * @description Category grouping for the format
             * @default misc
             * @enum {string}
             */
            category:
            ...
            /**
             * Description
             * @description Detailed description of the format intent
             * @default
             */
            description: string;
            /**
             * Default Score
             * @description Default score weight assigned when matched
             * @default 0
             */
            default_score: number;
            /**
             * Score
             * @description Active user-configured score weight
             * @default 0
             */
            score: number;
            /**
             * Enabled
             * @description Whether this custom format is actively evaluated
             * @default true
             */
            enabled: boolean;
            /**
             ...
             */
            conditions?: components["schemas"]["TrashCondition"][];
        };
        /** TrashCustomFormatsResponse */
        TrashCustomFormatsResponse: {
            /** Message */
            message: string;
            /** Custom Formats */
            custom_formats: components["schemas"]["TrashCustomFormat"][];
            /** Profiles */
            profiles: components["schemas"]["TrashProfile"][];
        };
        /** TrashEvaluateRequest */
        TrashEvaluateRequest: {
            /**
             * Raw Title
             * @description Release title to evaluate
             */
            raw_title: string;
            /**
             * Profile Id
             * @description Optional profile ID to evaluate with
             */
            ...
            /**
             * Is Anime
             * @description Whether release is anime (resolves anime profile)
             * @default false
             */
            is_anime: boolean;
            /**
             ...
             * @description Reject if net score < 0
             * @default false
             */
            reject_negative_scores: boolean;
            /**
             * Reject Unwanted Sources
             * @description Reject CAM/TS releases
             * @default true
             */
            reject_unwanted_sources: boolean;
            /**
             * Custom Formats
             * @description Optional custom formats list (defaults to active/catalog)
             */
            custom_formats?: components["schemas"]["TrashCustomFormat"][] | null;
        };
        /** TrashEvaluateResponse */
        TrashEvaluateResponse: {
            /** Message */
            message: string;
            summary: components["schemas"]["TrashEvaluationSummary"];
        };
        /**
         * TrashEvaluationSummary
         * @description Aggregate evaluation result of all TRaSH Custom Formats for a release.
         */
        TrashEvaluationSummary: {
            /**
             * Total Score
            ...
            /** Matched Formats */
            matched_formats?: components["schemas"]["TrashFormatMatchResult"][];
            /**
             * Rejected By Lq
             * @default false
             */
            rejected_by_lq: boolean;
            /** Rejection Reason */
         ...
         * @description Result of evaluating a single custom format against a title.
         */
        TrashFormatMatchResult: {
            /** Trash Id */
            trash_id: string;
        ...
        /**
         * TrashProfile
         * @description A collection of custom formats with associated score overrides and minimum/cutoff scores.
         */
        TrashProfile: {
            /**
             * Profile Id
            ...
            /**
             * Description
             * @description Description of the profile intent
             * @default
             */
            description: string;
            /**
...
export interface operations {
    ...
    get_trash_custom_formats: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TrashCustomFormatsResponse"];
                };
            };
            /** @description Not found */
            404: {
    ...
    evaluate_trash_custom_formats: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TrashEvaluateRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TrashEvaluateResponse"];
                };
            };
            /** @description Not found */
            404: {
